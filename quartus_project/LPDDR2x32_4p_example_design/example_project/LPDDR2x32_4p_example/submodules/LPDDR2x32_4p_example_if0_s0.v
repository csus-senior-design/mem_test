...
`timescale 1 ps / 1 ps
module LPDDR2x32_4p_example_if0_s0 (
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (24576),
		.INIT_FILE        ("LPDDR2x32_4p_example_if0_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	LPDDR2x32_4p_example_if0_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	LPDDR2x32_4p_example_if0_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
