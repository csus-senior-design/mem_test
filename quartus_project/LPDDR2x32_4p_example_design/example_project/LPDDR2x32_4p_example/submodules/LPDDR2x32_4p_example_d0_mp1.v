...
`timescale 1 ps / 1 ps
module LPDDR2x32_4p_example_d0_mp1 #(
		...
		parameter DRIVER_SIGNATURE                       = 1431634070,
		parameter TG_GEN_BYTE_ADDR                       = 1,
		parameter TG_NUM_DRIVER_LOOP                     = 1,
		parameter TG_ENABLE_UNIX_ID                      = 1,
		parameter TG_USE_UNIX_ID                         = 1,
	...
	generate
		...
		if (DRIVER_SIGNATURE != 1431634070)
		begin
			initial begin
				$display("Generated module instantiated with wrong parameters");
				$stop;
