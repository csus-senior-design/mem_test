// LPDDR2x32_4p_example_if0_mm_interconnect_1.v
...
`timescale 1 ps / 1 ps
module LPDDR2x32_4p_example_if0_mm_interconnect_1 (
	...
	LPDDR2x32_4p_example_if0_mm_interconnect_1_router router (
	...
	LPDDR2x32_4p_example_if0_mm_interconnect_1_router router_001 (
	...
	LPDDR2x32_4p_example_if0_mm_interconnect_1_router_002 router_002 (
	...
	LPDDR2x32_4p_example_if0_mm_interconnect_1_cmd_demux cmd_demux (
		.clk                (p0_avl_clk_clk),                                              //       clk.clk
		.reset              (dmaster_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	LPDDR2x32_4p_example_if0_mm_interconnect_1_cmd_demux_001 cmd_demux_001 (
		.clk                (seq_debug_clk_out_clk_clk),                    //       clk.clk
		.reset              (seq_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	LPDDR2x32_4p_example_if0_mm_interconnect_1_cmd_mux cmd_mux (
		.clk                 (p0_avl_clk_clk),                                              //       clk.clk
		.reset               (dmaster_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	LPDDR2x32_4p_example_if0_mm_interconnect_1_rsp_demux rsp_demux (
		.clk                (p0_avl_clk_clk),                                              //       clk.clk
		.reset              (dmaster_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	LPDDR2x32_4p_example_if0_mm_interconnect_1_rsp_mux rsp_mux (
		.clk                 (p0_avl_clk_clk),                                              //       clk.clk
		.reset               (dmaster_master_translator_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	LPDDR2x32_4p_example_if0_mm_interconnect_1_rsp_mux rsp_mux_001 (
		.clk                 (seq_debug_clk_out_clk_clk),                    //       clk.clk
		.reset               (seq_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	LPDDR2x32_4p_example_if0_mm_interconnect_1_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
