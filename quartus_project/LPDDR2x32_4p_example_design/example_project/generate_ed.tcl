...
lappend arg_list "--report-file=csv:LPDDR2x32_4p_example.csv"
lappend arg_list "--report-file=qip:LPDDR2x32_4p_example.qip"
lappend arg_list "--output-name=LPDDR2x32_4p_example"
...
lappend arg_list "--component-param=ENABLE_EXPORT_SEQ_DEBUG_BRIDGE=true"
...
lappend arg_list "--component-param=MEM_CLK_FREQ=252.0"
...
lappend arg_list "--component-param=NUM_OF_PORTS=4"
...
catch { eval [concat [list exec "C:/altera/15.0/quartus//sopc_builder/bin/ip-generate" --component-name=alt_mem_if_lpddr2_tg_ed] $arg_list] } temp
puts $temp
