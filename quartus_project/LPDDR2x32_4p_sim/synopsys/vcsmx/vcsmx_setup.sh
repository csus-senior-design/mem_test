...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog "$QSYS_SIMDIR/LPDDR2x32_4p/LPDDR2x32_4p_mm_interconnect_1_avalon_st_adapter_error_adapter_0.sv"    -work error_adapter_0                 
  vlogan +v2k           "$QSYS_SIMDIR/LPDDR2x32_4p/LPDDR2x32_4p_mm_interconnect_1_avalon_st_adapter.v"                     -work avalon_st_adapter               
  ...
  vlogan +v2k           "$QSYS_SIMDIR/LPDDR2x32_4p/LPDDR2x32_4p_s0_mm_interconnect_0_avalon_st_adapter.v"                  -work s0                              
  vlogan +v2k -sverilog "$QSYS_SIMDIR/LPDDR2x32_4p/LPDDR2x32_4p_s0_mm_interconnect_0_avalon_st_adapter_error_adapter_0.sv" -work s0                              
